...
int main (int argc, char* argv[]) {
  Darken_t* c = new Darken_t();
  c->init();
  FILE *f = fopen("Darken.vcd", "w");
  FILE *tee = fopen("Darken.stdio", "w");
...
cat >gold.vcd <<"EOF"
$timescale 1ps $end
$scope module Darken $end
$var wire 8 N0 io_in $end
...
cat >test.flo <<EOF
Darken::io_in = in/8
T0 = lsh/9 Darken::io_in 1
T1 = rsh/8 T0 0
Darken::io_out = out/8 T1
EOF
ln -s Darken.vcd test.vcd
