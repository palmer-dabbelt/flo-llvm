...
int main (int argc, char* argv[]) {
  FullAdder_t* module = new FullAdder_t();
  module->init();
...
$var wire 1 N1 io_b $end
$var wire 1 N2 io_a $end
$var wire 1 N3 a_xor_b $end
$var wire 1 N4 io_sum $end
$var wire 1 N5 a_and_cin $end
$var wire 1 N6 b_and_cin $end
$var wire 1 N7 a_and_b $end
$var wire 1 N8 io_cout $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
...
cat >test.stdin <<EOF
reset 5
wire_poke FullAdder.io_a 0x1
wire_poke FullAdder.io_b 0x1
wire_poke FullAdder.io_cin 0x0
step 1
wire_peek FullAdder.io_sum
wire_peek FullAdder.io_cout
wire_poke FullAdder.io_a 0x1
wire_poke FullAdder.io_b 0x1
wire_poke FullAdder.io_cin 0x0
step 1
...
wire_peek FullAdder.io_cout
wire_poke FullAdder.io_a 0x1
wire_poke FullAdder.io_b 0x0
wire_poke FullAdder.io_cin 0x1
step 1
wire_peek FullAdder.io_sum
wire_peek FullAdder.io_cout
wire_poke FullAdder.io_a 0x1
