...
int main (int argc, char* argv[]) {
  ShiftRegister_t* module = new ShiftRegister_t();
  module->init();
  ShiftRegister_api_t* api = new ShiftRegister_api_t();
  api->init(module);
  FILE *f = fopen("ShiftRegister.vcd", "w");
  FILE *tee = fopen("ShiftRegister.stdin", "w");
...
$var wire 1 N0 io_in $end
$var wire 1 N1 r0 $end
$var wire 1 N2 r1 $end
$var wire 1 N3 r2 $end
$var wire 1 N4 r3 $end
...
cat >test.stdin <<EOF
reset 5
wire_poke ShiftRegister.io_in 0x1
step 1
wire_poke ShiftRegister.io_in 0x1
step 1
wire_poke ShiftRegister.io_in 0x0
step 1
wire_poke ShiftRegister.io_in 0x1
step 1
wire_poke ShiftRegister.io_in 0x1
step 1
wire_peek ShiftRegister.io_out
wire_poke ShiftRegister.io_in 0x0
step 1
wire_peek ShiftRegister.io_out
wire_poke ShiftRegister.io_in 0x1
...
EOF
cat >test.flo <<EOF
ShiftRegister::io_in = in/1
ShiftRegister::r0 = reg/1 1 ShiftRegister::io_in
ShiftRegister::r1 = reg/1 1 ShiftRegister::r0
ShiftRegister::r2 = reg/1 1 ShiftRegister::r1
ShiftRegister::r3 = reg/1 1 ShiftRegister::r2
ShiftRegister::io_out = out/1 ShiftRegister::r3
EOF
ln -s ShiftRegister.vcd test.vcd
