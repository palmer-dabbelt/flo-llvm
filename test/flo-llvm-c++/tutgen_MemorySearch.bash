...
int main (int argc, char* argv[]) {
  MemorySearch_t* c = new MemorySearch_t();
  c->init();
  FILE *f = fopen("MemorySearch.vcd", "w");
  FILE *tee = fopen("MemorySearch.stdio", "w");
...
$var wire 1 N4 elts_0 $end
$var wire 3 N5 elts_1 $end
$var wire 4 N6 elts_2 $end
$var wire 4 N7 elts_3 $end
$var wire 2 N8 elts_4 $end
$var wire 3 N9 elts_5 $end
$var wire 4 N10 elts_6 $end
$var wire 1 N11 reset $end
$var wire 3 N12 index $end
$var wire 3 N13 io_address $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
...
MemorySearch::done = and/1 T4 T3
MemorySearch::io_done = out/1 MemorySearch::done
MemorySearch::elts_0 = out/1 0
MemorySearch::elts_1 = out/3 4
MemorySearch::elts_2 = out/4 15
MemorySearch::elts_3 = out/4 14
MemorySearch::elts_4 = out/2 2
MemorySearch::elts_5 = out/3 5
MemorySearch::elts_6 = out/4 13
reset = rst
T5 = mux/3 MemorySearch::io_en 0 MemorySearch::index
T6 = add/3 MemorySearch::index 1
T7 = not/1 MemorySearch::done
T8 = not/1 MemorySearch::io_en
T9 = and/1 T8 T7
T10 = mux/3 T9 T6 T5
MemorySearch::index__update = mux/3 reset 0 T10
