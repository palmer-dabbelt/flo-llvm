...
int main (int argc, char* argv[]) {
  Combinational_t* module = new Combinational_t();
  module->init();
  Combinational_api_t* api = new Combinational_api_t();
  api->init(module);
...
cat >gold.vcd <<"EOF"
$timescale 1ps $end
$scope module Combinational $end
$var wire 16 N0 io_y $end
$var wire 16 N1 io_x $end
$var wire 16 N2 io_z $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
...
cat >test.stdin <<EOF
reset 5
wire_poke Combinational.io_x 0xbb20
wire_poke Combinational.io_y 0xd4d9
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0x3d93
wire_poke Combinational.io_y 0x9b39
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0xa32d
wire_poke Combinational.io_y 0x4f1d
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0x8ce9
wire_poke Combinational.io_y 0x1df4
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0x98f8
wire_poke Combinational.io_y 0xc812
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0x554d
wire_poke Combinational.io_y 0x40b5
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0x629b
wire_poke Combinational.io_y 0x9cef
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0xfc1e
wire_poke Combinational.io_y 0xfb9a
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0xe112
wire_poke Combinational.io_y 0x5e8
step 1
wire_peek Combinational.io_z
wire_poke Combinational.io_x 0xf0f5
wire_poke Combinational.io_y 0x2d0c
step 1
wire_peek Combinational.io_z
quit
EOF
...
Combinational::io_x = in'16
T0 = add'16 Combinational::io_x Combinational::io_y
Combinational::io_z = out'16 T0
EOF
ln -s Combinational.vcd test.vcd
