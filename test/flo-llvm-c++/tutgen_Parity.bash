...
int main (int argc, char* argv[]) {
  Parity_t* module = new Parity_t();
  module->init();
  Parity_api_t* api = new Parity_api_t();
  api->init(module);
...
$var wire 1 N1 io_in $end
$var wire 1 N2 state $end
$var wire 1 N3 io_out $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
...
cat >test.stdin <<EOF
reset 5
wire_poke Parity.io_in 0x1
step 1
wire_peek Parity.io_out
wire_poke Parity.io_in 0x1
step 1
wire_peek Parity.io_out
wire_poke Parity.io_in 0x0
step 1
wire_peek Parity.io_out
wire_poke Parity.io_in 0x1
step 1
...
cat >test.flo <<EOF
reset = rst
T0 = eq/1 Parity::state 0
Parity::io_in = in/1
T1 = and/1 Parity::io_in T0
T2 = mux/1 T1 1 Parity::state
T3 = not/1 T0
T4 = and/1 Parity::io_in T3
T5 = mux/1 T4 0 T2
Parity::state__update = mux/1 reset 0 T5
Parity::state = reg/1 1 Parity::state__update
T6 = eq/1 Parity::state 1
Parity::io_out = out/1 T6
EOF
ln -s Parity.vcd test.vcd
