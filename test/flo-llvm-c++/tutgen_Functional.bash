...
int main (int argc, char* argv[]) {
  Functional_t* module = new Functional_t();
  module->init();
  Functional_api_t* api = new Functional_api_t();
  api->init(module);
...
cat >test.stdin <<EOF
reset 5
wire_poke Functional.io_x 0xbb20
wire_poke Functional.io_y 0xd4d9
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0x3d93
wire_poke Functional.io_y 0x9b39
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0xa32d
wire_poke Functional.io_y 0x4f1d
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0x8ce9
wire_poke Functional.io_y 0x1df4
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0x98f8
wire_poke Functional.io_y 0xc812
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0x554d
wire_poke Functional.io_y 0x40b5
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0x629b
wire_poke Functional.io_y 0x9cef
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0xfc1e
wire_poke Functional.io_y 0xfb9a
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0xe112
wire_poke Functional.io_y 0x5e8
step 1
wire_peek Functional.io_z
wire_poke Functional.io_x 0xf0f5
wire_poke Functional.io_y 0x2d0c
step 1
wire_peek Functional.io_z
quit
EOF
...
Functional::io_x = in/16
T0 = not/16 Functional::io_x
T1 = and/16 T0 Functional::io_y
T2 = and/16 Functional::io_x Functional::io_y
T3 = or/16 T2 T1
Functional::io_z = out/16 T3
EOF
ln -s Functional.vcd test.vcd
