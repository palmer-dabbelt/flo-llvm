...
int main (int argc, char* argv[]) {
  ByteSelector_t* module = new ByteSelector_t();
  module->init();
...
cat >gold.vcd <<"EOF"
$timescale 1ps $end
$scope module ByteSelector $end
$var wire 32 N0 io_in $end
$var wire 2 N1 io_offset $end
$var wire 8 N2 io_out $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
#0
b00000000101111000110000101001110 N0
b00 N1
b01001110 N2
#1
b01 N1
...
cat >test.stdin <<EOF
reset 5
wire_poke ByteSelector.io_in 0xbc614e
wire_poke ByteSelector.io_offset 0x0
step 1
wire_peek ByteSelector.io_out
wire_poke ByteSelector.io_in 0xbc614e
wire_poke ByteSelector.io_offset 0x1
step 1
wire_peek ByteSelector.io_out
wire_poke ByteSelector.io_in 0xbc614e
wire_poke ByteSelector.io_offset 0x2
step 1
wire_peek ByteSelector.io_out
wire_poke ByteSelector.io_in 0xbc614e
wire_poke ByteSelector.io_offset 0x3
step 1
wire_peek ByteSelector.io_out
quit
EOF
