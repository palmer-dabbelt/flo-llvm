...
int main (int argc, char* argv[]) {
  ResetShiftRegister_t* module = new ResetShiftRegister_t();
  module->init();
...
cat >gold.vcd <<"EOF"
$timescale 1ps $end
$scope module ResetShiftRegister $end
...
cat >test.stdin <<EOF
reset 5
wire_poke ResetShiftRegister.io_in 0x1
wire_poke ResetShiftRegister.io_shift 0x1
step 1
wire_peek ResetShiftRegister.io_out
wire_poke ResetShiftRegister.io_in 0x0
wire_poke ResetShiftRegister.io_shift 0x1
step 1
wire_peek ResetShiftRegister.io_out
wire_poke ResetShiftRegister.io_in 0x1
wire_poke ResetShiftRegister.io_shift 0x0
step 1
wire_peek ResetShiftRegister.io_out
wire_poke ResetShiftRegister.io_in 0x1
wire_poke ResetShiftRegister.io_shift 0x0
