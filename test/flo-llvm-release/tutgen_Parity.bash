...
cat >test.flo <<EOF
reset = rst
T0 = eq Parity::state 0'1
Parity::io_in = in'1
T1 = and Parity::io_in T0
T2 = mux T1 1'1 Parity::state
T3 = not'1 T0
T4 = and Parity::io_in T3
T5 = mux T4 0'1 T2
Parity::state__update = mux'1 reset 0'1 T5
Parity::state = reg'1 1 Parity::state__update
T6 = eq Parity::state 1'1
