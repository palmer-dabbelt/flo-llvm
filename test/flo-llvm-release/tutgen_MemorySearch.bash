...
int main (int argc, char* argv[]) {
  MemorySearch_t* module = new MemorySearch_t();
  module->init();
  MemorySearch_api_t* api = new MemorySearch_api_t();
  api->init(module);
...
cat >gold.vcd <<"EOF"
$timescale 1ps $end
$scope module MemorySearch $end
$var wire 4 N0 io_target $end
$var wire 1 N1 io_en $end
$var wire 1 N2 done $end
$var wire 1 N3 io_done $end
$var wire 1 N4 reset $end
$var wire 3 N5 index $end
$var wire 3 N6 io_address $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
...
cat >test.stdin <<EOF
reset 5
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0xb
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
step 1
wire_peek MemorySearch.io_done
step 1
wire_peek MemorySearch.io_done
...
step 1
wire_peek MemorySearch.io_done
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0xd
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0x3
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0x9
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0xa
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0x4
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0x8
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
wire_peek MemorySearch.io_address
wire_poke MemorySearch.io_en 0x1
wire_poke MemorySearch.io_target 0x1
step 1
wire_poke MemorySearch.io_en 0x0
step 1
wire_peek MemorySearch.io_done
...
init T1 5 5'4
init T1 6 13'4
T2 = rd'4 1 T1 MemorySearch::index
T3 = eq T2 MemorySearch::io_target
T4 = or T3 T0
MemorySearch::io_en = in'1
T5 = not'1 MemorySearch::io_en
MemorySearch::done = and T5 T4
MemorySearch::io_done = out'1 MemorySearch::done
reset = rst
T6 = mux MemorySearch::io_en 0'3 MemorySearch::index
T7 = add'3 MemorySearch::index 1'3
T8 = not'1 MemorySearch::done
T9 = not'1 MemorySearch::io_en
T10 = and T9 T8
T11 = mux T10 T7 T6
MemorySearch::index__update = mux'3 reset 0'3 T11
MemorySearch::index = reg'3 1 MemorySearch::index__update
MemorySearch::io_address = out'3 MemorySearch::index
EOF
ln -s MemorySearch.vcd test.vcd
