...
int main (int argc, char* argv[]) {
  HiLoMultiplier_t* module = new HiLoMultiplier_t();
  module->init();
  HiLoMultiplier_api_t* api = new HiLoMultiplier_api_t();
  api->init(module);
...
cat >gold.vcd <<"EOF"
$timescale 1ps $end
$scope module HiLoMultiplier $end
$var wire 16 N0 io_B $end
$var wire 16 N1 io_A $end
$var wire 32 N2 mult $end
$var wire 16 N3 io_Hi $end
$var wire 16 N4 io_Lo $end
$upscope $end
$enddefinitions $end
$dumpvars
$end
...
cat >test.stdin <<EOF
reset 5
wire_poke HiLoMultiplier.io_A 0xb7c0
wire_poke HiLoMultiplier.io_B 0x1309
step 1
wire_peek HiLoMultiplier.io_Lo
wire_peek HiLoMultiplier.io_Hi
wire_poke HiLoMultiplier.io_A 0x487
wire_poke HiLoMultiplier.io_B 0x5fc
step 1
wire_peek HiLoMultiplier.io_Lo
wire_peek HiLoMultiplier.io_Hi
wire_poke HiLoMultiplier.io_A 0x3692
wire_poke HiLoMultiplier.io_B 0x1fac
step 1
wire_peek HiLoMultiplier.io_Lo
wire_peek HiLoMultiplier.io_Hi
wire_poke HiLoMultiplier.io_A 0xfecf
wire_poke HiLoMultiplier.io_B 0x217b
step 1
wire_peek HiLoMultiplier.io_Lo
wire_peek HiLoMultiplier.io_Hi
quit
...
HiLoMultiplier::io_A = in'16
HiLoMultiplier::mult = mul'32 HiLoMultiplier::io_A HiLoMultiplier::io_B
T0 = rsh'16 HiLoMultiplier::mult 16'5
HiLoMultiplier::io_Hi = out'16 T0
T1 = rsh'16 HiLoMultiplier::mult 0'1
HiLoMultiplier::io_Lo = out'16 T1
EOF
ln -s HiLoMultiplier.vcd test.vcd
